...
//    private let rotationInterval: TimeInterval = 30.0 // 60 seconds per file
//    
...
//    
//    // Keep track of completed segments for ListeningCoordinator
//    private var completedSegmentIndex: Int = -1
//    
...
//        let filename = "\(baseFilename)-\(segmentindex).m4a"
...
//        print("prepare 불렸습니다 Before -- Seg Index \(segmentindex)")
//        if isInitial {
//            print("Intial == True --> Skipping Updating segment Index")
//            return (writer, writerInput)
//        }
//        segmentindex += 1
//        print("prepare 불렸습니다 After -- Seg Index \(segmentindex)")
//        
...
//            
//            print("🔄 Segment Index는? \(self.segmentindex)")
//            // Save current segment info before starting a new one
//            let completedSegmentIndex = self.segmentindex - 1
//            let completedFileName = self.currentFileName
//            
//            print("😡 CompletedSegmentIndex = \(completedSegmentIndex) -- \(completedFileName)")
//            
...
//            
//            // Finish old writer asynchronously and notify ListeningCoordinator when done
//            oldWriter?.finishWriting { [weak self] in
//                print("✅ Finished writing previous audio segment: \(completedFileName)")
//                
//                switch oldWriter?.status {
//                case .completed:
//                    print("✅ Finished writing previous audio segment successfully: \(completedFileName) (Index: \(completedSegmentIndex))")
//                case .failed:
//                    print("❌ Failed to finish writing previous audio segment: \(completedFileName) (Index: \(completedSegmentIndex))")
//                case .cancelled:
//                    print("⚠️ Writing cancelled for previous audio segment: \(completedFileName) (Index: \(completedSegmentIndex))")
//                default:
//                    print("Default Unexpected")
//                }
//                
//                // Notify ListeningCoordinator about the completed segment
//                DispatchQueue.main.async {
//                    print("🔄 About to call handleSystemAudioSegment for index: \(completedSegmentIndex)")
...
//    }
//    
//    // New method to start the rotation timer
...
//        
//        // Get final segment info before stopping
...
//                print("Final File Send index = \(finalSegmentIndex), file name = \(finalFileName)")
//                
//                // Notify ListeningCoordinator about the final segment with isFinished flag
//                DispatchQueue.main.async {
//                    if finalSegmentIndex >= 0 && !finalFileName.isEmpty {
//                        print("Final File Send index = \(finalSegmentIndex), file name = \(finalFileName)")
//                        
//                        ListeningCoordinator.shared.handleSystemAudioSegment(
...
//            }
//            
//            // Reset session identification properties
//            self?.sessionId = ""
//            self?.baseFilename = ""
